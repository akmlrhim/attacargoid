...
const DotField = memo(({
  ...
  useEffect(() => {
    ...
    // Cap DPR: 1 on mobile (huge win), max 2 on desktop
    ...
    function buildDots(w, h) {
      ...
      // Mobile: 2.5x spacing → ~6x fewer dots
      const spacingMult = isMobile ? 2.5 : 1;
    ...
    function tick() {
      ...
      // Mobile: skip odd frames → ~30fps cap
      ...
      // Engagement / glow only relevant on desktop
      if (!isMobile) {
      ...
      const eng = isMobile ? 0 : engagement.current;
