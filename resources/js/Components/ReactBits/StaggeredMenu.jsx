...
export const StaggeredMenu = ({
  ...
  const animateIcon = useCallback((opening) => {
    ...
    if (opening) {
      ...
      tl.to(
        bar2,
        { scaleX: 0, opacity: 0, duration: 0.18, ease: "power2.in" },
        0,
      )
        .to(bar1, { y: 7, rotate: 45, duration: 0.4, ease: "power3.out" }, 0.04)
        .to(
          bar3,
          { y: -7, rotate: -45, duration: 0.4, ease: "power3.out" },
          0.04,
        );
      ...
      tl.to(
        [bar1, bar3],
        { y: 0, rotate: 0, duration: 0.32, ease: "power3.out" },
        0,
      ).to(
        bar2,
        ...
        <div className="sm-panel-inner">
          ...
          {displaySocials && socialItems && socialItems.length > 0 && (
            <div className="sm-socials" aria-label="Social links">
              <h3 className="sm-socials-title">Kontak</h3>
