...
import { misiItems, nilaiItems } from "../constants/about";
      ...
      <AppLayout>
        ...
        <section className="relative overflow-hidden bg-navy-dark pt-36 pb-24 sm:pt-48 sm:pb-32">
          ...
          <div className="relative max-w-3xl mx-auto px-6 lg:px-8 text-center">
            ...
            <div className="hero-anim-ctas flex flex-col sm:flex-row gap-3 justify-center">
              <a
                href="/kontak"
                className="inline-flex items-center justify-center gap-2 bg-orange hover:bg-orange-dark text-white font-bold px-7 py-3.5 rounded-full text-sm transition-colors"
              >
                Hubungi Kami
              ...
              <a
                ...
                onClick={(e) => {
                  e.preventDefault();
                  window.__lenis?.scrollTo("#profil", {
                    duration: 1.4,
                    offset: -96,
                  });
                }}
                className="inline-flex items-center justify-center gap-2 bg-white/10 hover:bg-white/20 text-white font-bold px-7 py-3.5 rounded-full text-sm transition-colors border border-white/20"
              >
          ...
          <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 mt-4">
              ...
              <div className="sr sr-right bg-white rounded-3xl p-8 sm:p-10 border border-gray-100">
                ...
                <h3 className="text-xl sm:text-2xl font-black text-black leading-snug mb-6">
